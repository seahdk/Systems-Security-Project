...
def login():
    ...
    if request.method == "POST" and "username" in request.form and "password" in request.form:
        ...
        if user:
            ...
            if bcrypt.check_password_hash(user_hashpwd, password):
                ...
                if current_session_data:
                    ...
                    if not user["country"] == current_session_data["country_name"]:
                        log_malicious_activity(
                            True,
                    ...
                    msg = "Unable to fetch location and ip address"
        ...
        elif user.get('role') == "user" and bcrypt.check_password_hash( user_hashpwd, password):
            window = otp_verifier()
            window.button()
            window.mainloop()
            try:
